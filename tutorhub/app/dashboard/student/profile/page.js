...
const PREF_SUBJECTS = [
  ...
  {id:"ბიოლოგია",icon:"🌿"},{id:"გეოგრაფია",icon:"🌍"},{id:"ისტორია",icon:"🏛️"},
  {id:"ქართული ენა და ლიტერატურა",icon:"📖"},{id:"სამოქალაქო განათლება",icon:"🏛"},{id:"ინფორმატიკა",icon:"🖥️"},
  {id:"ეკონომიკა",icon:"📈"},
  // უცხო ენები
  {id:"ინგლისური ენა",icon:"🇬🇧"},{id:"გერმანული ენა",icon:"🇩🇪"},{id:"ფრანგული ენა",icon:"🇫🇷"},
  {id:"ესპანური ენა",icon:"🇪🇸"},{id:"რუსული ენა",icon:"🇷🇺"},{id:"ჩინური ენა",icon:"🇨🇳"},
  {id:"იაპონური ენა",icon:"🇯🇵"},{id:"არაბული ენა",icon:"🇸🇦"},
  // პროგრამირება & ტექნოლოგია
  {id:"Python",icon:"🐍"},{id:"JavaScript",icon:"🟨"},{id:"Java",icon:"☕"},
  {id:"C# / C++",icon:"⚙️"},{id:"Swift",icon:"🍎"},
  {id:"UI/UX დიზაინი",icon:"🎨"},{id:"გრაფიკული დიზაინი",icon:"🖌️"},{id:"3D მოდელირება",icon:"🧊"},
  {id:"კიბერუსაფრთხოება",icon:"🔐"},{id:"Cloud Computing",icon:"☁️"},{id:"მონაცემთა ბაზები (SQL)",icon:"🗄️"},
  // ბიზნესი & ფინანსები
  {id:"ციფრული მარკეტინგი",icon:"📣"},{id:"SMM და SEO",icon:"📱"},{id:"ბუღალტერია",icon:"🧾"},
  {id:"ფინანსური მოდელირება",icon:"💹"},{id:"პროექტების მართვა (Agile/Scrum)",icon:"📋"},
  // მუსიკა & ხელოვნება
  {id:"ფორტეპიანო",icon:"🎹"},{id:"გიტარა",icon:"🎸"},{id:"ვიოლინო",icon:"🎻"},
  {id:"დრამი",icon:"🥁"},{id:"სოლფეჯიო",icon:"🎼"},{id:"მუსიკალური თეორია",icon:"🎵"},
  {id:"ხატვა",icon:"🖼️"},{id:"ფოტოგრაფია",icon:"📷"},{id:"კინომონტაჟი",icon:"🎬"},
  // სხვა
  {id:"იოგა და მედიტაცია",icon:"🧘"},{id:"კულინარია",icon:"🍳"},{id:"ჭადრაკი",icon:"♟️"},
  {id:"საჯარო გამოსვლები",icon:"🎤"},{id:"სწრაფი კითხვა",icon:"📚"},{id:"მართვის მოწმობის თეორია",icon:"🚗"},
];
const PREF_TIMES = [
